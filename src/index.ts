...
import {
  ...
  getWaitStatsTool,
  getMemoryUsageTool,
  getDbMemoryUsageTool,
  getMemoryConditionTool,
  getDbccMemoryStatusTool,
  getMaxMemoryTool,
  setMaxMemoryTool,
  getPlanCacheTool,
  clearPlanCacheTool,
...
import {
  ...
  getDbOwnerTool,
  setDbOwnerTool,
  getDbRecoveryModelTool,
  setDbRecoveryModelTool,
  getDbCompatibilityTool,
  setDbCompatibilityTool,
  newDbSnapshotTool,
  getDbSnapshotTool,
  removeDbSnapshotTool,
  restoreDbSnapshotTool,
  shrinkDatabaseTool,
  setDbCollationTool,
} from './tools/database-management.js';
import {
  addDatabaseFileTool,
...
import {
  validatePgloaderInstallationTool,
  validatePgloaderMigrationTool,
  migrateDatabaseWithPgloaderTool,
  generatePgloaderConfigTool,
} from './tools/pgloader-migration.js';
import {
  dbccCheckDbTool,
  dbccCheckTableTool,
  dbccCheckConstraintsTool,
  dbccShowStatisticsTool,
  dbccFreeSystemCacheTool,
  dbccTraceStatusTool,
  dbccTraceOnTool,
  dbccTraceOffTool,
...
const tools = [
  ...
  // DBCC (Database Console Commands) tools
  dbccCheckDbTool,
  dbccCheckTableTool,
  dbccCheckConstraintsTool,
  dbccShowStatisticsTool,
...
const writeOperations = new Set([
  ...
  'sqlserver_set_max_memory',
  'sqlserver_clear_plan_cache',
  // Database management write operations
